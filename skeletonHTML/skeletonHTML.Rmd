...
params:
  output_filename: "skeletonHTML.html"
---
...
此模版產生一個使用 Skeleton framework的html檔。
...
<div id="myDiv2" class="exampleClass2"></div>
  ...
  * 以下範例來自: http://getskeleton.com/
  

```{r, eval=T, echo=F}
htmltools::includeHTML("external/within_body/skContent.html")
```
